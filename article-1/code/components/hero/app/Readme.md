...
## Monitoring in Heroku

- Open terminal (ensure you've installed heroku cli)
- `set PATH=%PATH%;C:\Program Files\heroku\bin`
- `heroku logs --tail -a oxecon-scraper`
- `heroku run bash -a oxecon-scraper`
- `heroku ps -a oxecon-scraper`
